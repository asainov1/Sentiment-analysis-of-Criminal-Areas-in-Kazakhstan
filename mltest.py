...
#CONSTANTS
POSITIVE_TWEETS_CSV = 'train_pos.json'
NEGATIVE_TWEETS_CSV = 'train_neg.json'
VOCAB_SIZE = 5000

#LOAD DATA
tweets_col_number = 3
#tweets = pd.read_json('train2.json', header=None, delimiter=';')[[tweets_col_number]]
positive_tweets = pd.read_json("train_pos.json", encoding = 'utf-8')
negative_tweets = pd.read_json("train_neg.json", encoding = 'utf-8')
